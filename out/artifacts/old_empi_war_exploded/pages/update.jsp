...
var city="<s:property  escape='false' value='pm.city'/>";
	...
	<body style="background-color:#f2f2f2;">
     ...
     <form id="UpdateForm" name="UpdateForm" action="patient_updatePation.action" method="post">
     <div>
      ...
      <table width="100%" align="center" style=" margin:0 atuo;" cellspacing="0" cellpadding="0" border="0" >
        ...
        <tr height="20">
          <td width="30"></td>
          <td width="8" style="color:#FF0000;" align="right">*</td>
          <td width="360" colspan="5">发布机构:</td>
        </tr>
         <tr height="30">
          <td></td>
          <td colspan="6"><input class="required" disabled="true" type="text" value="<s:property value='#request.patient.systemid'/>" name="pm.systemid" size="18"/></td>
        </tr>
        ...
        <tr height="20">
         ...
         <tr height="30">
          <td></td>
          <td colspan="6"><input disabled="true" id="localid" name="pm.localid"   class="{required:true,messages:{required:'请输入病人ID！！'}}" value="<s:property value='#request.patient.localid'/>" type="text" size="18"/></td>
        ...
        <tr height="20">
         ...
         <tr height="30">
          <td></td>
          <td colspan="3"><input style="width: 120px;" type="text" class="required"  value="<s:property value='#request.patient.nameString'/>" id="nameString" name="pm.nameString" /></td>
          <td colspan="3"><input style="width: 175px;"  name="pm.dob" class="required"  id="dob"  size="36"  value="<s:property value='#request.patient.time()'/>"  type="text" onFocus="WdatePicker({lang:'zh-cn',maxDate:'%y-%M-%d'})"  onkeydown="return false;" oncontextmenu="return false;" onpaste="return false;"/></td>   
        ...
        <tr>
        	...
        	<td colspan="2">
        		<select id="gender" name="pm.gender" style="width:125px;">
					...
					<option value="O" <s:if test="#request.patient.gender==O">selected="selected"</s:if> >==请选择==</option>
				</select>
        	</td>
        	 <td  ></td>
        	<td colspan="2" >
		  		...
		  		<select  name="pm.maritalStatus" style="width:125px;">
					<option value="M" <s:if test="#request.patient.maritalStatus==M">selected="selected"</s:if> >已婚</option>
					<option value="F" <s:if test="#request.patient.maritalStatus==F">selected="selected"</s:if> >未婚</option>
					<option value="O" <s:if test="#request.patient.maritalStatus==O">selected="selected"</s:if> >离异</option>
				</select>
		  		</td>
           <td ></td>
        </tr>    
        ...
        <tr height="30">
          <td></td>
          <td colspan="6"><input type="text" class="{required:true,isTel:true}" name="pm.phone"  value="<s:property value='#request.patient.phone'/>" size="18"/></td>
        </tr>
       <tr height="20">
          <td></td>
          <td width="8" style="color:#FF0000;" align="right">*</td>
         ...
         <tr height="30">
          <td></td>
          <td colspan="6"><input  class="{isIdCardNo:true,required:true}"  value="<s:property value='#request.patient.identityCard'/>"   type="text" name="pm.identityCard" size="18"/></td>
        </tr>
        <tr height="20">
          <td></td>
          <td width="8" style="color:#FF0000;" align="right">*</td>
         ...
         <tr height="30">
          <td></td>
          <td colspan="6"><input class="required"  type="text"  value="<s:property value='#request.patient.insuranceCard'/>" name="pm.insuranceCard" size="18"/></td>
        </tr>
        <tr height="20">
          <td></td>
          <td width="8" style="color:#FF0000;" align="right">*</td>
         ...
         <tr height="30">
          <td></td>
          <td colspan="6"><input  class="required" name="pm.socialCard"  value="<s:property value='#request.patient.socialCard'/>"  type="text" size="18"/></td>
        </tr>     
        <tr height="20">
          <td></td>
          <td width="8" style="color:#FF0000;" align="right">*</td>
         ...
         <tr height="30">
          <td></td>
          <td colspan="6"><input class="required"  id="address" name="pm.address"   value="<s:property value='#request.patient.address'/>"  type="text" size="18"/></td>
          <td colspan="6"><input type="hidden" lass="required"  id="address" name="pm.hospitalId"   value="<s:property value='#request.patient.hospitalId'/>"  type="text" size="18"/></td>
...
<!-- 单位信息 --> 
                      ...
                      <td>
                          ...
                          <table id="table2"  cellspacing="2" cellpadding="0" border="0"  align="center" style="width:100%; display:none;">
					         ...
					         <tr height="30">
					         	<td width="27"></td>
					          <td colspan="5">
					          	<input  name="pm.companyName"  value="<s:property value='#request.patient.companyName'/>"  type="text" size="18"/>
							</td>
					         ...
					         <tr height="30">
					         <td width="27"></td>
					          <td colspan="1"><input style="width:95px;" type="text" name="pm.companyPhone"  value="<s:property value='#request.patient.companyPhone'/>"  /></td>
					          <td colspan="4"><input style="width:205px;"  class="email" type="text"  value="<s:property value='#request.patient.companyEmail'/>"  name="pm.companyEmail"  /></td>
					        </tr>
					        ...
					        <tr height="20">
					         ...
					         <tr height="30">
					          <td></td>
					          <td colspan="5"><input  id="localid" name="pm.companyAdderss"  value="<s:property value='#request.patient.companyAdderss'/>"   type="text" size="18"/></td>
					        </tr>
 ...
 <!-- 联系人信息 -->  
              <table class="table_1" style="width:100%;position:relative; margin-bottom: 5px;"  cellpadding="0" cellspacing="0" disabled="ture">
                <tr>
                      <td>
                          <table class="table_top_1" border="0" height="20" cellspacing="0" cellpadding="0" bgcolor="#90c7ff" style="width:100%;">
                              <tr bgcolor="#b1c7df">
                           ...
                           <table id="xxx"  cellspacing="2" cellpadding="0"  style="width:100%; display:none;">
					         ...
					         <tr height="30">
					         <td width="27"></td>
					          <td colspan="1"><input style="width:95px;" type="text"  name="pm.relationName"  value="<s:property value='#request.patient.relationName'/>"  /></td>
					          <td colspan="4"><input style="width:205px;" type="text"  name="pm.relationShip"   value="<s:property value='#request.patient.relationShip'/>" /></td>
					        </tr>
					        <tr height="20">
					          <td></td>
					        ...
					        <tr height="30">
					          <td></td>
					          <td colspan="5"><input  type="text" name="pm.relationPhone" size="18"/ value="<s:property value='#request.patient.relationPhone'/>" ></td>
					        </tr>
					       <tr height="20">
					          <td></td>
					         ...
					         <tr height="30">
					          <td></td>
					          <td colspan="5"><input type="text" name="pm.relationHomePhone" size="18" value="<s:property value='#request.patient.relationHomePhone'/>" /></td>
					        </tr>
					        <tr height="20">
					          <td></td>
					         ...
					         <tr height="30">
					          <td></td>
					          <td colspan="5"><input type="text" name="pm.relationAddress" value="<s:property value='#request.patient.relationAddress'/>" size="18"/></td>
					        </tr>
	 ...
	 <table class="table_1" style="width:100%;position:relative; margin-bottom: 5px;" cellspacing="0" cellpadding="0" border="0" disabled="true">
                      ...
                      <td>
                          <table class="table_top_1" border="0" height="20" cellspacing="0" cellpadding="0" bgcolor="#90c7ff" style="width:100%;">
                           ...
                           <table id="table3" border="0" cellspacing="2" cellpadding="0" style="width:100%; display:none;">
					         ...
					         <tr height="30">
					         <td width="27"></td>
					          <td colspan="1"><input style="width:95px;" type="text"  name="pm.citizenShip"  value="<s:property value='#request.patient.citizenShip'/>"/></td>
					          <td colspan="4"><input style="width:205px;" type="text"  value="<s:property value='#request.patient.nativPlace'/>" name="pm.nativePlace" /></td>
					        </tr>
					        <tr height="20">
					          <td></td>
					          <td colspan="5">学历:</td>
					        ...
					        <tr height="30">
					          <td></td>
					          <td colspan="5"><input type="text" name="pm.education" value="<s:property value='#request.patient.education'/>" size="18"/></td>
					        </tr>
					       <tr height="20">
					          <td></td>
					          <td colspan="5">邮箱:</td>
					         ...
					         <tr height="30">
					          <td></td>
					          <td colspan="5"><input   type="text" name="pm.email" size="18" value="<s:property value='#request.patient.email'/>"/></td>
					        </tr>
       ...
       <tr>
         <td colspan="7">
           <div class="update_l_buttom">
            <div class="buttom_left"></div>
     		<div class="update_buttom_box" >
     		<div  style="width:80px; float:left;height:100%; width:99px; font-weight:bold; display:block; text-align:center; border-right:#9d9b9b solid 1px;"><div onclick="javascript:window.history.back();">返回</div></div>
           <div  class="l_b_s"><input type="submit" style="width:100px;border: none;height: 34px;"  value="更新" class="l_b_s"/></div>
           <div  style="float:left;height:100%; width:99px; font-weight:bold; display:block; text-align:center; border-left:#9d9b9b solid 1px;" onclick="clearForm();">重置</div>
       </div>
