...
public class NextOfKin {
    ...
    private RelationshipTypeDict relationshipTypeDict;
	...
	/**
	 * @return the relationshipTypeDict
	 */
	public RelationshipTypeDict getRelationshipTypeDict() {
		return relationshipTypeDict;
	}


	/**
	 * @param relationshipTypeDict the relationshipTypeDict to set
	 */
	public void setRelationshipTypeDict(RelationshipTypeDict relationshipTypeDict) {
		this.relationshipTypeDict = relationshipTypeDict;
	}
