package com.ats.aexchange.utils.hl7;
...
import com.ats.aexchange.datamodel.PersonIdentifier;
...
public class HL7Utils {
	...
	public static Date fromDTM(String dtm) {
		...
		return HL7v231Utils.parseDateTimeGMT(dtm);
	}
	...
	public static String toDT(Date date) {
		if (date == null) return null;
		return HL7v231Utils.formatDate(date);
	}
	...
	public static Date fromDT(String date) {
		if (date == null) return null;
		return HL7v231Utils.parseDate(date);
	}
