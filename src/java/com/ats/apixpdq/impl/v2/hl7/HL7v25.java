...
public class HL7v25 {
   ...
   */
    public static void populateMSH(MSH msh, String type, String event,String msgStructureid, String id, IConnectionDescription connection) throws DataTypeException, IheConfigurationException {
        // MSH-1
        ...
        msh.getMessageType().getMessageStructure().setValue(msgStructureid);
        // MSH-10
