...
public class PatientVisitHistory extends BaseObject implements java.io.Serializable {
	...
	/** full constructor */
	public PatientVisitHistory(Long historyId,String globalId,Long visitId,Long personId, 
			String personDomain,String visitFlowId,String visitFlowDomain,String hospitalDomain,String patCategory,
			...
			String otherMedicalInstitutions, Date createDate,String createid,
			Date voidedDate, String voidedId,
			Date modifyDate, String modifyId, String custom1, String custom2,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PatientVisitHistory))
			return false;
		PatientVisitHistory castOther = (PatientVisitHistory) other;

		return ((this.getHistoryId() == castOther.getHistoryId()) || (this
				.getHistoryId() != null
				&& castOther.getHistoryId() != null && this.getHistoryId().equals(
				castOther.getHistoryId())))
