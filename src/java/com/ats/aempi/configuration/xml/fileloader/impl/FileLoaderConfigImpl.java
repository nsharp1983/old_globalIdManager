 ...
 */
public class FileLoaderConfigImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.ats.aempi.configuration.xml.fileloader.FileLoaderConfig
{
     ...
     */
    public com.ats.aempi.configuration.xml.fileloader.DataFields getDataFields()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.ats.aempi.configuration.xml.fileloader.DataFields target = null;
            target = (com.ats.aempi.configuration.xml.fileloader.DataFields)get_store().find_element_user(DATAFIELDS$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDataFields(com.ats.aempi.configuration.xml.fileloader.DataFields dataFields)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.ats.aempi.configuration.xml.fileloader.DataFields)get_store().add_element_user(DATAFIELDS$2);
            }
     ...
     */
    public com.ats.aempi.configuration.xml.fileloader.DataFields addNewDataFields()
    {
        synchronized (monitor())
        {
            check_orphaned();
