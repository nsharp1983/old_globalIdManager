 ...
 */
public class ExtensionTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.ats.aempi.configuration.xml.mpicomponent.ExtensionType
{
     ...
     */
    public com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface.Enum getInterface()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface xgetInterface()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface target = null;
            target = (com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface)get_store().find_attribute_user(INTERFACE$4);
            return target;
        }
    }
     ...
     */
    public void setInterface(com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface.Enum xinterface)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetInterface(com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface xinterface)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface)get_store().add_attribute_user(INTERFACE$4);
            }
     ...
     */
    public static class InterfaceImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.ats.aempi.configuration.xml.mpicomponent.ExtensionType.Interface
    {
