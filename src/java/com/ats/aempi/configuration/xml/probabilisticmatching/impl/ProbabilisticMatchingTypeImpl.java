 ...
 */
public class ProbabilisticMatchingTypeImpl extends com.ats.aempi.configuration.xml.impl.MatchingConfigurationTypeImpl implements com.ats.aempi.configuration.xml.probabilisticmatching.ProbabilisticMatchingType
{
     ...
     */
    public com.ats.aempi.configuration.xml.probabilisticmatching.MatchFields getMatchFields()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.ats.aempi.configuration.xml.probabilisticmatching.MatchFields target = null;
            target = (com.ats.aempi.configuration.xml.probabilisticmatching.MatchFields)get_store().find_element_user(MATCHFIELDS$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMatchFields(com.ats.aempi.configuration.xml.probabilisticmatching.MatchFields matchFields)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.ats.aempi.configuration.xml.probabilisticmatching.MatchFields)get_store().add_element_user(MATCHFIELDS$4);
            }
     ...
     */
    public com.ats.aempi.configuration.xml.probabilisticmatching.MatchFields addNewMatchFields()
    {
        synchronized (monitor())
        {
            check_orphaned();
