 ...
 */
public class MatchFieldImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.ats.aempi.configuration.xml.probabilisticmatching.MatchField
{
     ...
     */
    public com.ats.aempi.configuration.xml.ComparatorFunction getComparatorFunction()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.ats.aempi.configuration.xml.ComparatorFunction target = null;
            target = (com.ats.aempi.configuration.xml.ComparatorFunction)get_store().find_element_user(COMPARATORFUNCTION$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setComparatorFunction(com.ats.aempi.configuration.xml.ComparatorFunction comparatorFunction)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.ats.aempi.configuration.xml.ComparatorFunction)get_store().add_element_user(COMPARATORFUNCTION$6);
            }
     ...
     */
    public com.ats.aempi.configuration.xml.ComparatorFunction addNewComparatorFunction()
    {
        synchronized (monitor())
        {
            check_orphaned();
