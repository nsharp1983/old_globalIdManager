 ...
 */
public class DateConverterEMPI implements Converter {
    ...
    public Object convert(Class type, Object value) {
        if (value == null) {
            ...
            return convertToDate(type, value, DateUtilEMPI.getDateTimePattern());
        } else if (type == Date.class) {
            return convertToDate(type, value, DateUtilEMPI.getDatePattern());
    ...
    protected Object convertToString(Class type, Object value) {
        ...
        if (value instanceof Date) {
            DateFormat df = new SimpleDateFormat(DateUtilEMPI.getDatePattern());
            if (value instanceof Timestamp) {
                df = new SimpleDateFormat(DateUtilEMPI.getDateTimePattern());
            } 
